...
def mean_vec_compute(word2vec_model, words):
...
def main():
    ...
    st.title("COVID Clinical Trial Search Engine")      #title of our app
    ...
    def preprocessing_input(query):
        ...
        query=query.replace('\n',' ')
        K=mean_vec_compute(word2vec_model,query)    
        return K   
    ...
    st.write("Analysis on Abstract Column")
    if query:
    ...
    st.write("Data Source: https://dimensions.figshare.com/articles/dataset/Dimensions_COVID-19_publications_datasets_and_clinical_trials/11961063")
